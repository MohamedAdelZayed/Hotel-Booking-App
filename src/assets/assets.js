...
import egyptImg from './egypt.jpg';
import parisImg from './paris.jpg';
import romaImg from './roma.jpg';
import dubaiImg from './dubai.jpg';
import newYorkImg from './new york.jpg';


import HomeVideo from './main-9kxH7-xb.mp4'
...
export const ExploreCities = [
    {
      name: "Paris, France",
      stays: 243,
      description: "Elegant hotels near the Eiffel Tower, romantic streets, and rich culture.",
      image: assets.parisImg
    },
    {
      name: "Dubai, UAE",
      stays: 187,
      description: "Luxury skyscraper hotels, desert tours, and exclusive shopping experiences.",
      image: assets.dubaiImg
    },
    {
      name: "Rome, Italy",
      stays: 159,
      description: "Stay steps away from historic landmarks and charming piazzas.",
      image: assets.romaImg
    },
    {
      name: "Cairo, Egypt",
      stays: 205,
      description: "Explore ancient history with modern comfort near the Nile and pyramids.",
      image: assets.egyptImg
    },
    {
      name: "New York, USA",
      stays: 212,
      description: "Central hotels surrounded by Broadway shows, parks, and iconic skyscrapers.",
      image: assets.newYorkImg
    }
];
...
export const roomCommonData = [
    { icon: assets.homeIcon, title: "Clean & Safe Stay", description: "A well-maintained and hygienic space for you." },
    { icon: assets.badgeIcon, title: "Enhanced Cleaning", description: "This host follows strict cleaning standards." },
...
export const roomsDummyData = [
  ...
  },
  {
    ...
    "hotel": {
      name: "Tokyo Crescent Hotel",
      location: "Ginza Dori, Tokyo, Japan",
      rating: 4.8,
    },
    "roomType": "Single Bed",
    "pricePerNight": 899,
  ...
  },
  {
    ...
    "hotel": {
      name: "Palmstone Hotel",
      location: "Corniche El Nile, Cairo, Egypt",
      rating: 4.6,
    },
    "roomType": "Single Bed",
    "pricePerNight": 199,
